  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 pb-16">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">{doc.title}</h1>
        <p className="text-sm text-gray-400 mb-8">{doc.updated}</p>

        <div className="space-y-6">
          {doc.sections.map((s, i) => (
            <div key={i} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 md:p-6">
