...
export const uz: Translations = {
  ...
  period6m: '6 oy',
  period1y: 'Yil',
  totalRepaid: "Jami qabul qilindi",
  ...
  planSectionTitle: 'Tarifni tanlang',
  freePlanTitle: 'Bepul tarif',
  paidPlanTitle: "Obuna — 29 so'm/oy",
  popularBadge: 'Mashhur',
  planFeature2Businesses: '2 ta biznes',
  planFeature50Clients: 'Har biznesga 50 ta mijoz',
  planFeature3Members: 'Biznesga 3 ta xodim',
  planFeature10Sms: 'Oyiga 10 ta SMS',
  planFeatureCore: "Qarzlar, nasiya, tahlil",
