...
export const en: Translations = {
  ...
  paidPlanTitle: 'Subscription — 29 som/mo.',
  popularBadge: 'Popular',
  planFeature2Businesses: '2 businesses',
  planFeature50Clients: '50 clients per business',
  planFeature3Members: '3 employees per business',
  planFeature10Sms: '10 SMS per month',
  planFeatureCore: 'Debts, installments, analytics',
